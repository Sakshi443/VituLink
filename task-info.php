...
// Check if a chat message has been submitted
if(isset($_POST['send_message'])) {
    $message = trim($_POST['message']);
    $sender_name = $_SESSION['name']; // Using the user's name from the session

    // Insert chat message into database
    $sql = "INSERT INTO chat_messages (sender_name, message) VALUES (:sender_name, :message)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute(['sender_name' => $sender_name, 'message' => $message]);
